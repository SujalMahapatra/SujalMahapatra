# 💫 About Me:
# 👋 Hi, I'm Sujal Mahapatra<br><br>🚀 AI/ML Engineer | Full-Stack Developer | Open Source Contributor<br><br>I'm passionate about building intelligent applications that combine Artificial Intelligence, Machine Learning, and scalable software engineering. My interests span Generative AI, AI Agents, Deep Learning, Data Science, Cloud Technologies, and Full-Stack Development.<br><br>🔹 Building AI-powered solutions using Python, Java, React, FastAPI, and modern AI frameworks<br>🔹 Exploring Multi-Agent Systems, LLM Applications, RAG Architectures, and Agentic AI<br>🔹 Open Source Contributor (GSSoC '25 & GSSoC '26)<br>🔹 AWS Certified Generative AI Developer – Professional<br>🔹 AWS Certified Machine Learning Engineer – Associate<br>🔹 Microsoft, IBM, Oracle & Google Cloud AI Learner<br>🔹 Interested in Software Development, AI Engineering, and Cloud-Native Applications<br><br>### 💻 Tech Stack<br><br>**Languages:** Python, Java, JavaScript, PHP<br>**Frontend:** React.js, HTML, CSS<br>**Backend:** FastAPI, Flask, Node.js<br>**AI/ML:** TensorFlow, Scikit-Learn, NLP, Deep Learning, Generative AI, AI Agents<br>**Databases:** MySQL, MongoDB<br>**Tools:** Git, GitHub, Docker, Postman, Streamlit<br>**Cloud:** AWS, Google Cloud, IBM Cloud<br><br>### 🌱 Currently Learning<br><br>* Advanced AI Agent Architectures<br>* Agentic Workflows & MCP<br>* Cloud Deployment & MLOps<br>* Scalable AI Product Development<br><br>### 🎯 Goal<br><br>To build impactful AI products that solve real-world problems and create meaningful value through technology.<br>
...
# 📊 GitHub Stats:
![](https://github-readme-stats.shion.dev/api?username=SujalMahapatra&theme=noctis_minimus&hide_border=false&include_all_commits=true&count_private=true)<br/>
![](https://streak-stats.demolab.com/?user=SujalMahapatra&theme=noctis_minimus&hide_border=false)<br/>
![](https://github-readme-stats.shion.dev/api/top-langs/?username=SujalMahapatra&theme=noctis_minimus&hide_border=false&include_all_commits=true&count_private=true&layout=compact)
...
## 🏆 GitHub Trophies
![](https://github-profile-trophy.vercel.app/?username=SujalMahapatra&theme=radical&no-frame=false&no-bg=false&margin-w=4)
